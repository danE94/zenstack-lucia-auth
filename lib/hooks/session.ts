...
export function useCreateSession(
    options?: Omit<UseMutationOptions<Session | undefined, unknown, Prisma.SessionCreateArgs, unknown>, 'mutationFn'>,
...
export function useCreateManySession(
    options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SessionCreateManyArgs, unknown>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
...
export function useFindManySession<T extends Prisma.SessionFindManyArgs>(
    ...
    options?: Omit<UseQueryOptions<Array<Prisma.SessionGetPayload<T> & { $optimistic?: boolean }>>, 'queryKey'>,
    optimisticUpdate: boolean = true,
) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery('Session', `${endpoint}/session/findMany`, args, options, fetch, optimisticUpdate);
}
...
export function useFindUniqueSession<T extends Prisma.SessionFindUniqueArgs>(
    ...
    options?: Omit<UseQueryOptions<Prisma.SessionGetPayload<T> & { $optimistic?: boolean }>, 'queryKey'>,
    optimisticUpdate: boolean = true,
) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery('Session', `${endpoint}/session/findUnique`, args, options, fetch, optimisticUpdate);
}
...
export function useFindFirstSession<T extends Prisma.SessionFindFirstArgs>(
    ...
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery('Session', `${endpoint}/session/findFirst`, args, options, fetch, optimisticUpdate);
}

export function useUpdateSession(
    options?: Omit<UseMutationOptions<Session | undefined, unknown, Prisma.SessionUpdateArgs, unknown>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useUpdateManySession(
    options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SessionUpdateManyArgs, unknown>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
...
export function useUpsertSession(
    options?: Omit<UseMutationOptions<Session | undefined, unknown, Prisma.SessionUpsertArgs, unknown>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useDeleteSession(
    options?: Omit<UseMutationOptions<Session | undefined, unknown, Prisma.SessionDeleteArgs, unknown>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useDeleteManySession(
    options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SessionDeleteManyArgs, unknown>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
